              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div style={{
                  ...
                  <div className=" flex justify-between items-start space-x-4">
                    <div className="">
                      <Label htmlFor="ai-tasks">AI Task Creation</Label>
                      <p className="text-sm text-muted-foreground mt-1">
                        Let AI analyze your project title and description to automatically generate relevant tasks.
                        <span className="block text-yellow-600 dark:text-yellow-500 mt-1">
                          This will use 2 AI credits
                        </span>
                      </p>
                    </div>
                    <Switch
